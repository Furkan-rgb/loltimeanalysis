...
async def get_puuid(client: httpx.AsyncClient, game_name: str, tag_line: str, region: str = "europe") -> str:
...
async def get_match_ids_async(client: httpx.AsyncClient, puuid: str, count: int, start_index: int, region: str = "europe") -> list | None:
...
async def get_match_details_async(client: httpx.AsyncClient, match_id: str, puuid: str, region: str = "europe") -> dict | None:
